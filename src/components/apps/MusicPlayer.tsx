...
// Import audio files
import PerfectAudio from '../assets/music/Chand Ne Kaho.mp3';
import PrettyLittle from '../assets/music/perfect.mp3';
import TumMile from '../assets/music/Sang Rahiyo.mp3';
